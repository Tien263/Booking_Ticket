...
>>>>>>> main
                    ...
                    <div class="col-lg-6 col-md-12">
                        <nav class="main_menu clearfix">
                            <ul class="ul_li_center clearfix">
                                <li class="active has_child"><a href="home.jsp">Trang chủ</a></li>
...
>>>>>>> main
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                            <div class="reg_form" data-aos="fade-up" data-aos-delay="500">
                                ...
                                <p>
                                    Tiết kiệm lên đến 15% khi đặt vé xe buýt trên trang web của chúng tôi, với mạng lưới tuyến đường rộng và đội ngũ hỗ trợ khách hàng tận tâm.
                                </p>
                                <span class="new_account mb_15">Đăng nhập hoặc <a href="#" id="scrollToRegister">Tạo tài khoản?</a></span>
                                <form action="cuslogin" method="post">
                                    <div class="form_item">
                                        <input type="text" name="email" placeholder="Your email" required>
                                    </div>
                    ...
                    <form id="registerForm" action="register" method="POST">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" data-aos="fade-up" data-aos-delay="700">
                                ...
                                <div class="border p-3 rounded mb-3">
                                    <p class="font-weight-bold mb-2">Mật khẩu phải bao gồm:</p>
                                    <ul class="list-unstyled">
...
=======
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#scrollToRegister").on("click", function (e) {
                e.preventDefault();
                $("html, body").animate({
