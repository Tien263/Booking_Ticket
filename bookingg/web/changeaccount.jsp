                            ...
                            <div class="account_tab_content tab-content">
                                <div id="admin_tab" class="tab-pane active">
                                    <div class="account_info_list" data-aos="fade-up" data-aos-delay="100">
                                        ...
                                        <div class="ul_li_block clearfix">
                                            <form action="change1" method="POST" enctype="multipart/form-data">
                                                <div>
                                                ...
                                                <div>
                                                    ...
                                                    <select  name="gender" required>
                                                        <option value="1" <c:if test="${customer.isGender()}">selected</c:if>>Male</option>
                                                        <option value="0" <c:if test="${!customer.isGender()}">selected</c:if>>Female</option>
                                                        </select>
                                                    </div>
