...
public class ContactController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        // Gửi thông báo thành công về lại contact.jsp
        request.setAttribute("successMessage", "Gửi liên hệ thành công! Cảm ơn bạn đã liên hệ,Chúng tôi sẽ phản hồi lại sớm .");
