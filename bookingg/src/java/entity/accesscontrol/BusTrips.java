...
public class BusTrips {
    ...
    public BusTrips(int bt1_id, String bt1_date, String bt1_departureTime, String bt1_arrivalTime, String bt1_status, int br_id) {
        this.bt1_id = bt1_id;
    ...
    public String getBt1_date() {
        return bt1_date;
    }

    public void setBt1_date(String bt1_date) {
        this.bt1_date = bt1_date;
    }
