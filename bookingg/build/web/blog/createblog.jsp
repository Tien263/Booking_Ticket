...
<head>
    ...
    <title>Tạo Blog Mới - BusGo</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="nav flex-column">
            <li class="nav-item">
                <a class="nav-link" href="updateblog"><i class="fas fa-road me-2"></i>Cập nhập Blog</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="listblog"><i class="fas fa-bus me-2"></i>Quản lý Blog</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active" href="createblog"><i class="fas fa-blog me-2"></i>Tạo Blog</a>
            </li>
    ...
    <div class="content">
        ...
        <div class="header">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Tạo Blog Mới</li>
                </ol>
            </nav>
        </div>
        ...
        <div class="form-container">
            ...
            <form action="${pageContext.request.contextPath}/blog/createblog" method="post" enctype="multipart/form-data" id="createBlogForm">
                <div class="row">
                ...
                <!-- Nút Đăng bài và Xem danh sách bài viết -->
                <div class="submit-btn">
                    <button type="submit"><i class="fas fa-save me-2"></i>Đăng bài</button>
