    ...
    <head>
        ...
        <style>
            ...
            .success-notification {
                ...
                display: none;
                z-index: 1000;
                animation: tingting 0.5s ease-in-out;
            }
            @keyframes tingting {
            ...
            <section class="register_section sec_ptb_100 clearfix">
                <div class="container">
                    <div class="register_card mb-0" data-bg-color="#F2F2F2" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <form action="resetpasswordcustomer" method="POST" id="resetPasswordForm">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" data-aos="fade-up" data-aos-delay="500">
                                    ...
                                    <div class="form_item text-center mt-4">
                                        <button type="submit" class="custom_btn bg_default_red text-uppercase">Xác nhận</button>
                                    </div>
                                </div>
                            </div>
                        </form>
            ...
            <c:if test="${not empty successMessage}">
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    setTimeout(function() {
                        ...
                        // Chuyển hướng về trang đăng nhập sau khi thông báo biến mất
