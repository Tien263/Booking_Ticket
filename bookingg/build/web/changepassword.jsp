            ...
            <section class="breadcrumb_section text-center clearfix">
                <div class="page_title_area has_overlay d-flex align-items-center clearfix" data-bg-image="assets/images/breadcrumb/bg_08_1.png">
                    <div class="container" data-aos="fade-up" data-aos-delay="100">
                        <h1 class="page_title text-white mb-0">Change Password</h1>
                    </div>
                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" data-aos="fade-up" data-aos-delay="700">
                                    ...
                                    <div class="form_item">
                                        ...
                                        <input type="password" name="retypeNewPassword" id="retypeNewPassword" required>
                                    </div>
                                </div>
                            </div>

                            <div class="border p-3 rounded mb-3" data-aos="fade-up" data-aos-delay="900">
                                <p class="font-weight-bold mb-2">Your password must contain:</p>
                                <ul class="list-unstyled">
                                    <li class="d-flex align-items-center">
                                        <i id="lengthIcon" class="fas fa-times text-danger mr-2"></i> At least 8 characters
                                    </li>
                                    <li class="d-flex align-items-center">
                                        <i id="varietyIcon" class="fas fa-times text-danger mr-2"></i> At least 3 of the following:
                                        <ul class="list-unstyled ml-4">
                                            <li id="lowercase" class="d-flex align-items-center">
                                                <i class="fas fa-times text-danger mr-2"></i> Lower case letters (a-z)
                                            </li>
                                            <li id="uppercase" class="d-flex align-items-center">
                                                <i class="fas fa-times text-danger mr-2"></i> Upper case letters (A-Z)
                                            </li>
                                            <li id="numbers" class="d-flex align-items-center">
                                                <i class="fas fa-times text-danger mr-2"></i> Numbers (0-9)
                                            </li>
                                            <li id="special" class="d-flex align-items-center">
                                                <i class="fas fa-times text-danger mr-2"></i> Special characters (!@#$%^&*)
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="d-flex align-items-center">
                                        <i id="repeatIcon" class="fas fa-times text-danger mr-2"></i> No more than 2 identical characters in a row
                                    </li>
                                    <li class="d-flex align-items-center">
                                        <i id="matchIcon" class="fas fa-times text-danger mr-2"></i> Passwords must match
                                    </li>
                                </ul>
                            </div>

                            <div class="form_item text-center mt-4">
                                <button type="submit" class="custom_btn bg_default_red text-uppercase">Change Password</button>
                            </div>
        ...
        <script>
            $(document).ready(function () {
                function validatePassword() {
                    ...
                    const confirm = $('#retypeNewPassword').val();
                    ...
                    // Kiểm tra số lượng loại ký tự (phải có ít nhất 3 trong 4)
                    ...
                    // Cập nhật icon cho từng điều kiện
                    updateIcon('#lengthIcon', isLengthValid);
                    updateIcon('#lowercase i', hasLowercase);
                    updateIcon('#uppercase i', hasUppercase);
                    updateIcon('#numbers i', hasNumbers);
                    updateIcon('#special i', hasSpecial);
                    updateIcon('#varietyIcon', isVarietyValid);
                    updateIcon('#repeatIcon', isRepeatValid);
                    updateIcon('#matchIcon', isMatchValid);

                    return isLengthValid && isVarietyValid && isRepeatValid && isMatchValid;
                }

                // Hàm cập nhật dấu X (❌) hoặc dấu V (✅)
                function updateIcon(selector, isValid) {
                    let icon = $(selector);
                    if (isValid) {
                ...
                $('#newPassword, #retypeNewPassword').on('input', validatePassword);
