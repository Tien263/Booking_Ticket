...
<html lang="en">
    <head>
        ...
        <title>Cập nhật thông tin nhân viên - BusGo</title>
            ...
            <section class="breadcrumb_section text-center clearfix">
                <div class="page_title_area has_overlay d-flex align-items-center clearfix" data-bg-image="${pageContext.request.contextPath}/assets/images/breadcrumb/bg_08_1.png">
                    <div class="container" data-aos="fade-up" data-aos-delay="100">
                        <h1 class="page_title text-white mb-0">Cập nhật thông tin nhân viên</h1>
                    </div>
                </div>
                        ...
                        <form action="employee_update" method="POST">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" data-aos="fade-up" data-aos-delay="500">
                                    <div class="form_item">
                                        <label for="e_name">Họ và tên</label>
                                        <input type="text" id="e_name" name="e_name" value="${user.emp[0].name}" required />
                                    </div>
                                    <div class="form_item">
                                        <label for="e_phone">Số điện thoại</label>
                                        <input type="text" id="e_phone" name="e_phone" value="${user.emp[0].phone}" required />
                                    </div>
                                    <div class="form_item">
                                        <label for="e_address">Địa chỉ</label>
                                        <input type="text" id="e_address" name="e_address" value="${user.emp[0].address}" required />
                                    </div>
                                    <div class="form_item">
                                        <label for="e_gender">Giới tính</label>
                                        <select id="e_gender" name="e_gender" required>
                                            <option value="true" ${user.emp[0].gender ? "selected" : ""}>Nam</option>
                                            <option value="false" ${!user.emp[0].gender ? "selected" : ""}>Nữ</option>
                                        </select>
                                    </div>
                                    <div class="form_item text-center mt-4">
                                        <button type="submit" class="custom_btn bg_default_red text-uppercase">Cập nhật</button>
                                    </div>
                                </div>
                            </div>
                        </form>
