...
<html lang="en">
    <head>
        ...
        <title>My Bus - Admin Dashboard</title>
        ...
        <style>
            ...
            .sidebar-menu li a.menu-item span {
                display: none; /* Hidden when collapsed */
            }

            .sidebar.expanded .sidebar-menu li a.menu-item span {
                display: inline; /* Visible when expanded */
            }

            .sidebar-menu li a.menu-item:hover,
            .sidebar-menu li.active a.menu-item {
                background-color: #2e3b5b; /* Hover and active background color */
            }
    ...
    <body>
        ...
        <div class="sidebar" id="sidebar">
            <div class="sidebar-header">
                <div class="brand_logo">
                    <a href="home.jsp">
                        <img src="${pageContext.request.contextPath}/assets/images/logo/logo_01_1.png" alt="logo_not_found" width="50%">
                    </a>
                </div>
            </div>
            <ul class="sidebar-menu">
                <li class="active">
                    <a href="employeelist" class="menu-item">
                        <i class="fal fa-list"></i>
                        <span>Quản lý nhân viên</span>
                    </a>
                </li>
                <li>
                    <a href="ticketList.jsp" class="menu-item">
                        <i class="fal fa-ticket-alt"></i>
                        <span>Quản Lý Vé Xe</span>
                    </a>
                </li>
                <li>
                    <a href="listbusroute" class="menu-item">
                ...
                <li>
                    <a href="listbustrip" class="menu-item">
                        <i class="fal fa-bus"></i>
                        <span>Quản Lý Chuyến Xe</span>
                    </a>
                </li>
                <li>
                    <a href="vehicleList.jsp" class="menu-item">
            ...
            <section class="breadcrumb_section text-center clearfix">
                <div class="page_title_area has_overlay d-flex align-items-center clearfix" data-bg-image="${pageContext.request.contextPath}/assets/images/breadcrumb/bg_08_1.jpg">
                    <div class="container" data-aos="fade-up" data-aos-delay="100">
                        <h1 class="page_title text-white mb-0">Admin Dashboard</h1>
                    </div>
                </div>
                        ...
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><a href="employeelist" class="btn-action">Truy cập</a></td>
                                </tr>
                                <tr>
                                    <td>Xem danh sách chuyến</td>
                                    <td><a href="listbustrip" class="btn-action">Truy cập</a></td>
                                </tr>
                                <tr>
                                    <td>Xem danh sách tuyến</td>
                                    <td><a href="listbusroute" class="btn-action">Truy cập</a></td>
                                </tr>
                                <tr>
                                    <td>Xem danh sách vé</td>
                                    <td><a href="ticketList.jsp" class="btn-action">Truy cập</a></td>
                                </tr>
                                <tr>
                                    <td>Xem danh sách xe</td>
                                    <td><a href="vehicleList.jsp" class="btn-action">Truy cập</a></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
