...
<html>
<head>
    <title>Thêm Phương Tiện - BusGo</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="addVehicle.jsp"><i class="fas fa-blog me-2"></i>Tạo phương tiện</a>
            </li>
            <li class="nav-item">
        ...
        <div class="header">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Thêm Phương Tiện</li>
                </ol>
            </nav>
        </div>
