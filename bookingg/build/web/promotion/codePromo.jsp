...
<head>
    ...
    <title>Quản Lý Mã Giảm Giá - BusGo</title>
            ...
            deleteButtons.forEach(button => {
                button.addEventListener("click", function () {
                    if (confirm("Bạn có chắc chắn muốn xóa mã giảm giá này?")) {
                        ...
                        window.location.href = "promotion_code?action=delete&id=" + id;
                    }
                });
            });
        });
...
<body>
    ...
    <div class="content">
        ...
        <button type="button" class="btn btn-success btn-add" data-bs-toggle="modal" data-bs-target="#addCodePromoModal">
            <i class="fas fa-plus me-2"></i> Thêm Mã Giảm Giá
        </button>

        <!-- Form lọc -->
        <div class="filter-form">
            <form action="promotion_code" method="get" class="row g-3">
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    ...
                    <button type="button" class="btn btn-secondary" onclick="window.location.href='promotion_code'"><i class="fas fa-eraser me-2"></i> Xóa</button>
                </div>
            </form>
        </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-warning btn-sm edit-btn"
                                    ...
                                    data-bs-target="#editCodePromoModal"
                                    data-id="${promo.id}"
            ...
            <nav aria-label="Page navigation">
                <ul class="pagination">
                    <li class="page-item ${currentPage == 1 ? 'disabled' : ''}">
                        <a class="page-link" href="promotion_code?page=${currentPage - 1}" aria-label="Previous">
                            <span aria-hidden="true">Trang trước</span>
                        </a>
                    </li>
                    <c:forEach begin="1" end="${totalPages}" var="i">
                        <li class="page-item ${currentPage == i ? 'active' : ''}">
                            <a class="page-link" href="promotion_code?page=${i}">${i}</a>
                        </li>
                    </c:forEach>
                    <li class="page-item ${currentPage == totalPages ? 'disabled' : ''}">
                        <a class="page-link" href="promotion_code?page=${currentPage + 1}" aria-label="Next">
    ...
    <div class="modal fade" id="addCodePromoModal" tabindex="-1" aria-labelledby="addCodePromoModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addCodePromoModalLabel">Thêm Mã Giảm Giá</h5>
    ...
    <div class="modal fade" id="editCodePromoModal" tabindex="-1" aria-labelledby="editCodePromoModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editCodePromoModalLabel">Chỉnh Sửa Mã Giảm Giá</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="promotion_code" method="post">
                        ...
                        <div class="mb-3">
                            <label class="form-label">Mã Giảm Giá</label>
                            <input type="text" id="editPromoCode" name="code" class="form-control" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Ngày Hết Hạn</label>
