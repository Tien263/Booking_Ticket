					...
					<div class="row align-items-center justify-content-lg-between">
						<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
							<div class="banner_content">
								<h1 class="text-white text-uppercase" data-aos="fade-up" data-aos-delay="100">BusGo - Easy and Safe Bus Ticket Booking</h1>
					...
					<div class="advance_search_form">
						<div class="section_title text-center mb_30">
							<h2 class="title_text mb-0 text-white" data-aos="fade-up" data-aos-delay="100">
								<span>Search for a Bus Trip</span>
							</h2>
						</div>
						<form action="#">
							<div class="row">
								...
								<div class="col-lg-12 text-left mb-3">
									...
									<label class="ml-4">
										<input type="radio" name="trip_type" value="roundtrip"> Round-trip
									</label>
									<a href="#" class="float-right text-danger">Ticket booking guide</a>
								</div>
					
								<!-- Điểm đi -->
								<div class="col-lg-4 col-md-6 col-sm-12">
									<div class="form_item" data-aos="fade-up" data-aos-delay="100">
										<h4 class="input_title text-white">Origin</h4>
								...
								<div class="col-lg-4 col-md-6 col-sm-12">
									<div class="form_item" data-aos="fade-up" data-aos-delay="100">
										<h4 class="input_title text-white">Destinaion</h4>
								...
								<div class="col-lg-2 col-md-6 col-sm-12">
									<div class="form_item" data-aos="fade-up" data-aos-delay="100">
										<h4 class="input_title text-white">Depature date</h4>
								...
								<div class="col-lg-2 col-md-6 col-sm-12">
									<div class="form_item" data-aos="fade-up" data-aos-delay="100">
										<h4 class="input_title text-white">Ticket</h4>
							...
							<div class="col-lg-9 col-md-8 col-sm-12 col-xs-12">
								<div class="offer_content">
									<h2 class="item_title" data-aos="fade-up" data-aos-delay="100">
										Why Choose Us? – The Best Bus Ticket Booking Experience 
									</h2>
									<p class="mb_30" data-aos="fade-up" data-aos-delay="300">
										At BusGo, we are committed to providing a safe, fast, and convenient bus ticket booking experience. With our modern booking system, customers can easily select their preferred trips in just a few simple steps. To show our appreciation, we offer exclusive discounts for new users, daily promotions, and special privileges for loyal members.
									</p>
									<p class="mb_30" data-aos="fade-up" data-aos-delay="300">
										Beyond great deals, service quality is our top priority. We collaborate with trusted bus operators to ensure every journey is safe, comfortable, and reliable. Moreover, our 24/7 customer support team is always available to assist you, ensuring a smooth and hassle-free travel experience.
